...
SECRET_KEY = 'django-insecure-_1_1puqdxb__rxuck(qal-a&rcf(e221l7=_4qw&4kl5hnt2q6'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # ajouter ca pour le corsheaders
...
CORS_ALLOW_ALL_ORIGINS = True # cela permet a react de faire des requetes vers le backend sans probleme de cors
...
# Ajoute aussi la config du cache pour le bouton STOP
CACHES = {
    "default": {
